                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-responsive"  style="margin-bottom: 0px;">
                                                    <tbody class="col-xs-12" style="padding-left: 0px;">
                                                        ...
                                                        <?php foreach ($common['size_color'][$i] as $key => $value): ?>
                                                            <tr>
                                                                <td><?php echo $key; ?></td>
                                                                <td><?php echo $value['price_color']; ?></td>
                                                                <td><?php echo $value['promotion_color']; ?></td>
                                                                <td>
                                                                    <?php echo ($value['promotion_check'] == 'false') ? '<i class="fa fa-times" style="color:red;font-size: 1.2em"></i>' : '<i class="fa fa-check" style="color:green;font-size: 1.2em"></i>' ?>
                                                                </td>
