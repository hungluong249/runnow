...
<input type="text" value='<?php echo json_encode($size_product); ?>' placeholder="" class="form-control hidden" id="size_product">
                                            ...
                                            <?php for($k=0;$k<count($common['color']);$k++): ?>
                                                <div>
                                                    <div class="btn btn-primary col-ms-12 color_product" style="padding:0px; padding-top:5px; width:100%;text-align:left">
                                                        ...
                                                        <i style="float: right;padding-right:5px;" class="fa-2x fa fa-close remove" onclick="remove_color('<?php echo $k+1;?>')"></i>
                                                    </div>
                                                    <div id="demo<?php echo $k+1;?>" class="collapse in form-group">
                                                        <div class="col-xs-12" style="padding:0px;">
                                                            ...
                                                            <div class="col-xs-12" style="padding:0px;">
                                                                ...
                                                                <?php foreach ($size_product as $key => $value): ?>
                                                                    <div class="col-xs-3">
                                                                        <label class="checkbox-inline">
                                                                            <input type="checkbox" name="" onchange="check_size(this)" class="size_check" value="<?php echo $value['vi'];?>" <?php echo (in_array($value['vi'], $common['size'][$k])) ? 'checked' : '';?> /><span><?php echo $value['vi'];?></span>
                                                                        </label>
                                                                    </div>
                                                                <?php endforeach ?>
                                                            </div>
                                                            <div class="col-xs-12 add-all-size" style="padding:5px;">
                                                                <?php foreach ($common['size_color'][$k] as $key => $value): ?>
                                                                    <div class="size<?php echo $key;?>">
                                                                        <div class="col-xs-12">
                                                                            <label class="col-xs-12" style="padding:0px; color:green;margin-top:5px; border-top:1px solid green;">Size <?php echo $key;?></label>
                                                                        </div>
                                                                        <div class="col-sm-6 col-xs-12">
                                                                            <label class="control-label" for="inputError">Giá của sản phẩm</label>
                                                                            <input type="text" name="" value="<?php echo $value['price_color'] ?>" onpaste ="return false" onkeypress=" return check_sale(event,this)" placeholder="(Đơn vị VND)" class="form-control price_color">
                                                                        </div>
                                                                        <div class="col-sm-6 col-xs-12">
                                                                            <label class="control-label" for="inputError">Giá khuyến mãi sản phẩm</label>
                                                                            <input type="text" name="" value="<?php echo $value['promotion_color'] ?>" placeholder="(Đơn vị VND)" onpaste ="return false" onkeypress=" return check_sale(event,this)" class="form-control promotion_color">
                                                                        </div>
                                                                        <div class="col-sm-6 col-xs-12">
                                                                            <label class="control-label" for="inputError">Số lượng sản phẩm</label>
                                                                            <input type="text" name="" value="<?php echo $value['quantity'] ?>" placeholder="" class="form-control quantity">
                                                                        </div>
                                                                        <div class="col-sm-6 col-xs-12 style_checkbox">
                                                                            <label class="checkbox-inline">
                                                                                <input type="checkbox" name="" class="promotion_check" <?php echo ($value['promotion_check'] == 'true')? 'checked' : ''; ?> /><span>Hiển thị khuyến mãi cho sản phẩm</span>
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                <?php endforeach ?>
